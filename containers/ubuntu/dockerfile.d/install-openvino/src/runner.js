/**
 * Figure out some environmental information about a runner.
 */
...
/**
 * @returns {object} with the OpenVINO-compatible `os` and `arch` from the environment
 * or, if that is not available, from the NodeJS `os` module
 */
...
/**
 * @param {ReadStream} readStream - a readable stream of an `os-release` file with `ID=` and
...
module.exports = { readEnvironment, readLinuxRelease };
